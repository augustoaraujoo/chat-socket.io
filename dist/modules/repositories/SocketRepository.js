...
var server_1 = require("../../shared/infra/http/server");
var SocketRepository = /** @class */ (function () {
    function SocketRepository() {
        this.users = [];
    }
    SocketRepository.prototype.connectSocketIO = function () {
            ...
            return __generator(this, function (_a) {
                server_1.io.on("connection", function (socket) {
                    socket.on("select_room", function (data) {
                        ...
                        var userInRoom = _this.users.find(function (user) { return user.username === data.username && user.room === data.room; });
                        if (userInRoom) {
...
//# sourceMappingURL=SocketRepository.js.map